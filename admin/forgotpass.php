...
if(isset($_SESSION['forgotpass'])){
   ...
   if($_SESSION['forgotpass']){
	  ...
	  <p>Your new password has been generated and sent to the email <br>associated with your account. <a href="../main.php">Main</a>.</p>';
   }
   /**
    ...
    */
      ...
      echo '<p>There was an error sending you the email with the new password,<br> so your password has not been changed. <a href="http://'.$_SERVER['SERVER_NAME'].'/main.php">Main</a>.</p>';
   }
...
<b>Username:</b> <input type="text" name="user" maxlength="30" value="<?php echo $form->getValue("user"); ?>">
